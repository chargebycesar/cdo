...
import { initializeFirestore, getFirestore, doc, setDoc, getDoc, getDocFromServer, onSnapshot, persistentLocalCache, persistentMultipleTabManager } from 'firebase/firestore';
...
export { signInWithPopup, signOut, onAuthStateChanged, doc, setDoc, getDoc, getDocFromServer, onSnapshot };
export type { User };
